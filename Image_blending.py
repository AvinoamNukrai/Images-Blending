...
def plot_results(image1, image2, mask, blend_image):
    """
...
def blending_example1():
    ...
    blend_image = rgb_images_blending(image1, image2, mask, 200, 10, 50)
    plot_results(image1, image2, mask.astype(np.float64), (blend_image * MAX_GS).astype(np.uint8))
...
def blending_example2():
    ...
    and out the blended image
    """
    image1 = read_image(relpath("externals/avi.jpg"), RGB)
